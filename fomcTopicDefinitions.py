...
topics =    {'broad_topics' :
            ...
            'policy_topics' :
                ...
                'Forward guidance' : ['forward guidance', "expect", "committee will"],
            ...
            #    'Covid' : ["covid", "virus", "coronavirus", "covid-19", "covid19","pandemic"],
                ...
                "Recession" : ["recession"],
                'Recovery' : ["recovery", "recovered", "recovering", "recover", "rebound", "rebounded", "improve"],
                'Expand' : ["expand", "increase", "expanding", "expanded", "expansion"],
...
intensifiers = ["very", "enormous", "huge", "terribly", "exceptionally", "extremely","amazingly", "remarkably", "significant", "extreme", "significantly", "rapid", "rapidly", "sharp", "severely","substantial", "substantially", "terribly", "sharply"] ###ny
...
in_deep_topics = {
            ...
            'inflation' : {
                ...
                'Wages' : ["wages", "wage", "average hourly"],
                'Energy' : ["energy"],
...
sentiment_words = {'negative': ['abandon', 'abandoned', 'abandoning', 'abandonment', 'abandonments', 'abandons', 'abdicated',
